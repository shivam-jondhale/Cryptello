...
public class WalletController {
    ...
    public ResponseEntity<PaymentResponse> depositMoney(
            ...
            @PathVariable java.math.BigDecimal amount) throws Exception {
        User user = userService.findUserProfileByJwt(jwt);
        ...
        PaymentOrder order = paymentService.createOrder(user, amount, PaymentMethod.STRIPE);

        PaymentResponse res = paymentService.createStripePaymentLink(user, amount);
    ...
    public ResponseEntity<Wallet> addMoneyToWallet(
        ...
        Boolean status = paymentService.ProccedPaymentOrder(order, paymentId, null);
    ...
    // public ResponseEntity<PaymentResponse> withdrawMoney(@PathVariable Long
    // userId, @PathVariable Long amount) throws Exception {
    //
